...
Skills are licensed under [CC-BY-4.0](https://creativecommons.org/licenses/by/4.0/). Templates are too.
...
**Runtime** (CLI, scripts): [MIT](LICENSE)

**Content** (skills/, templates/): [CC-BY-4.0](LICENSE-CC-BY-4.0)
